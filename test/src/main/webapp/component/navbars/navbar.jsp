	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="index.jsp"><i
					class="fa fa-home" aria-hidden="true"></i><b> Home</b><span
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						Are you sure you want to logout? <br> <a type="button"
							class="btn btn-success text-light mt-3 mr-3" data-dismiss="modal">No,I
							don't</a> <a href="LogouServlet" type="button"
							class="btn btn-danger mt-3">Yes,I want</a>
